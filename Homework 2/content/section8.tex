...
\textit{Nhận xét:} Mặc dù kết quả đo của từng qubit là ngẫu nhiên, tuy nhiên chúng lại có sự tương quan hoàn toàn với nhau.
\begin{itemize}
...
Trạng thái ban đầu là $\ket{000}$ và trạng thái mục tiêu của ta là $\frac{1}{\sqrt{2}} \ket{000} + \frac{1}{\sqrt{2}}\ket{111}$, ta có mạch như sau:

\begin{center}
    \begin{quantikz}
        \lstick{$q_0$} & \gate{H} & \ctrl{1} & \ctrl{2} && \rstick[3]{$\ket{GHZ}$} \qw \\
        \lstick{$q_1$} & \qw & \targ{} & \qw && \qw \\
