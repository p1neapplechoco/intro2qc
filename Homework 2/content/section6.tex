...
\begin{itemize}
    \item Xác suất qubit $1$ bằng $0$ là: $P(q_1 = 0) = P(00) + P(10) = \frac{1}{4} + \frac{1}{4} = \frac{1}{2} = 50\%$.
    \item Xác suất qubit $1$ bằng $1$ là: $P(q_1 = 1) = P(01) + P(11) = 0 + \frac{1}{2} = \frac{1}{2} = 50\%$.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Xác suất đo tiếp qubit 1 bằng 0 là: $\frac{P(10)}{P(q_0 = 0)} = \frac{1}{3} \approx 33.3\%$.
        \item Xác suất đo tiếp qubit 1 bằng 1 là: $\frac{P(11)}{P(q_0= 0)} = \frac{2}{3} \approx 66.7\%$.
    \end{itemize}
\end{itemize}
