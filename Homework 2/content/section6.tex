...
\begin{itemize}
    ...
    \item Qubit 0 được 1 với xác suất: $\left| -\frac{i}{2}\ket{0} +  \frac{1}{\sqrt{2}} \ket{1} \right|^2 = \frac{1}{4} + \frac{1}{2} = \frac{3}{4}$ và trạng thái sụp đổ thành $-\frac{i}{2} \ket{10} + \frac{1}{\sqrt{2}} \ket{11} $, sau đó, ta đo qubit 1:
    \begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Qubit 1 được 1 với xác suất $\left| \frac{1}{\sqrt{2}} \ket{1} \right| = \frac{1}{2}$ và trạng thái sụp đổ thành $\frac{1}{\sqrt{2}} \ket{11}$, sau đó, ta đo qubit 0 chắc chắn sẽ ra 1.
\end{itemize}