...
\end{bmatrix} =
\begin{bmatrix}
    \frac{1 + 2\sqrt{3}}{9} + \frac{2}{9}i \\
    \frac{5 + 2\sqrt{3}}{18} + \frac{2 - 4\sqrt{3}}{18}i
\end{bmatrix}
\]
...
\end{bmatrix} =
\begin{bmatrix}
    \frac{\sqrt{3}(1 + 2\sqrt{3})}{12} - \frac{\sqrt{3}}{6}i \\
    \frac{1 + 2\sqrt{3}}{12} - \frac{1}{6}i
\end{bmatrix}
\]
...
\begin{align*}
    e_1 &= \frac{\operatorname{proj}_{\ket{\psi}}{\ket{\phi}}}{\|\operatorname{proj}_{\ket{\psi}}{\ket{\phi}}\|} \\
    &= 
    \begin{bmatrix}
        \frac{1 + 2\sqrt{3}}{9} + \frac{2}{9}i \\
        \frac{5 + 2\sqrt{3}}{18} + \frac{2 - 4\sqrt{3}}{18}i
    \end{bmatrix}
    \frac{1}{\sqrt{\left|\frac{1 + 2\sqrt{3}}{9} + \frac{2}{9}i \right|^2 + \left|\frac{5 + 2\sqrt{3}}{18} + \frac{2 - 4\sqrt{3}}{18}i\right|^2}}
\end{align*}

\begin{align*}
    e_2 &= \frac{\operatorname{proj}_{\ket{\phi}}{\ket{\psi}}}{\|\operatorname{proj}_{\ket{\phi}}{\ket{\psi}}\|} \\
    &= 
    \begin{bmatrix}
        \frac{\sqrt{3}(1 + 2\sqrt{3})}{12} - \frac{\sqrt{3}}{6}i \\
        \frac{1 + 2\sqrt{3}}{12} - \frac{1}{6}i
    \end{bmatrix}
    \frac{1}{\sqrt{\left|\frac{\sqrt{3}(1 + 2\sqrt{3})}{12} - \frac{\sqrt{3}}{6}i \right|^2 + \left|\frac{1 + 2\sqrt{3}}{12} - \frac{1}{6}i\right|^2}}
\end{align*}
...
\[
\begin{cases}
    \left[\ket{\phi}\right]_{B_X} = \left(\braket{+}{\phi}, \braket{-}{\phi}\right) = \left(\frac{\sqrt{6} + \sqrt{2}}{4}, \frac{\sqrt{6} - \sqrt{2}}{4}\right) \\
    \left[\ket{\psi}\right]_{B_X} = \left(\braket{+}{\psi}, \braket{-}{\psi}\right) = \left(\frac{\sqrt{2}(2 + 1 - 2i)}{3\sqrt{2}}, \frac{\sqrt{2}(2 - 1 + 2i)}{3\sqrt{2}}\right) = \left(\frac{3 - 2i}{3}, \frac{1 + 2i}{3}\right)
\end{cases}
\]
...
\[
\begin{cases}
    \left[\ket{\phi}\right]_{B_Y} = \left(\braket{i}{\phi}, \braket{-i}{\phi}\right) = \left(\frac{\sqrt{6} - i\sqrt{2}}{4}, \frac{\sqrt{6} + i\sqrt{2}}{4}\right) \\
    \left[\ket{\psi}\right]_{B_Y} = \left(\braket{i}{\psi}, \braket{-i}{\psi}\right) = \left(\frac{2 - i(1 - 2i)}{3\sqrt{2}}, \frac{2 + i(1 - 2i)}{3\sqrt{2}}\right) = \left(\frac{(4 - i)\sqrt{2}}{6}, \frac{i\sqrt{2}}{6}\right)
\end{cases}
\]
...
\[
\begin{cases}
    \left[\ket{\phi}\right]_{B} = \left(\braket{a}{\phi}, \braket{b}{\phi}\right) = \left(\frac{3}{4} - \frac{i}{4}, \frac{\sqrt{3}}{4} - \frac{i\sqrt{3}}{4}\right) \\
    \left[\ket{\psi}\right]_{B} = \left(\braket{a}{\psi}, \braket{b}{\psi}\right) = \left(\frac{\sqrt{3} - 1}{3} - \frac{i}{6}, \frac{i}{3} + \frac{\sqrt{3}(1 - 2i)}{6}\right)
\end{cases}
\]