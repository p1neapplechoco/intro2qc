...
\[
\begin{cases}
    \left[\ket{\phi}\right]_{B} = \left(\braket{a}{\phi}, \braket{b}{\phi}\right) = \left(\frac{3}{4} - \frac{i}{4}, \frac{-\sqrt{3}}{4} - \frac{\sqrt{3}}{4}i\right) \\
    \left[\ket{\psi}\right]_{B} = \left(\braket{a}{\psi}, \braket{b}{\psi}\right) = \left(\frac{-1 + \sqrt{3}}{3} - \frac{i}{3}, \frac{\sqrt{3}}{6} - \frac{1 + \sqrt{2}}{3}i\right)
\end{cases}
\]