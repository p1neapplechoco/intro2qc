...
Ta có:
\[
\sqrt[4]{x} = x^{\frac{1}{4}} = \left(e^{i \frac{\pi}{3}}\right)^{\frac{1}{4}}  = e^{i \frac{\pi}{12}} = \cos \frac{\pi}{12} + i \sin \frac{\pi}{12} = \frac{\sqrt{6} + \sqrt{2}}{4} + \frac{\sqrt{6} - \sqrt{2}}{4} i
\]
Tương tự, với $n \in \mathbb{N^+}$:
\[
\sqrt[n]{x} = x^{\frac{1}{n}} = \left(e^{i \frac{\pi}{3}}\right)^{\frac{1}{n}}  = e^{i \frac{\pi}{3n}} = \cos \frac{\pi}{3n} + i \sin \frac{\pi}{3n}
\]
